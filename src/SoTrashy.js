    ...
    return (
      ...
      <div className="card">
        ...
        <div className="card-body">
          ...
          <p className="card-text">So Trashy uses data visualization to represent New York City's Department of Sanitation's yearly collection of refuse & recycling from 2014 to 2018.</p>
