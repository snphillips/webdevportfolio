...
export default function About(props) {
  return (
    <ContentContainer id='about'>
      ...
      <AboutColumns>
        I am a Toronto-born, Brooklyn-based developer formally trained in art with a background in
        municipal service delivery. <br />
        <br />
        Most recently, I was employed as a Software Engineer for ed-tech startup Newsela where I
        worked on two internal tools on the content team. Prior to that, I worked as an Interaction
        Engineer at the ad tech startup TripleLift where I created bespoke, consumer-centric
        templates for programatic ads and developed the in-house React application our team used to
