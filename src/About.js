        ...
        <hr />
         <Heading>About</Heading>
          <AboutColumns>
            ...
            have taken place on the set of the show Parks & Recreation).  Most recently, I worked for 2.5 years as an Interaction Engineer at TripleLift, 
            where I created bespoke, consumer-centric templates for programatic ads and developed the in-house React application we used to create
            those templates. I strive to create visually interesting solutions that are broadly appealing. 
